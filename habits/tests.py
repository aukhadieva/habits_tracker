...
class HabitTestCase(test.APITestCase):
    ...
    def setUp(self):
        self.user = User.objects.create(email='test@bk.ru', password=123, tg_chat_id='123')
        self.client.force_authenticate(user=self.user)
        self.habit = Habit.objects.create(owner=self.user, behavior='test', time='12:12:00', location='test')
    ...
    def test_habit_create(self):
        ...
        data = {'owner': self.user.pk, 'behavior': 'test2', 'time': '13:13:00', 'location': 'test2'}
    ...
    def test_user_update(self):
        ...
        data = {'owner': self.user.pk, 'behavior': 'test2', 'time': '13:15:00', 'location': 'test2',
                'frequency': 1}
